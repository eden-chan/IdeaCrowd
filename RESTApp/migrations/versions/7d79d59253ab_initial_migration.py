...
Revision ID: 7d79d59253ab
Revises: 
Create Date: 2021-02-20 14:55:42.606415
...
def upgrade():
    ...
    op.create_table('projectelements',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_projectelements_type'), 'projectelements', ['type'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_projectelements_type'), table_name='projectelements')
    op.drop_table('projectelements')
